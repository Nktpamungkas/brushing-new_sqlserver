...
<body>
    ...
    <input type="button" name="button" id="button" value="Cetak Ke Excel"
        onClick="window.location.href='pages/reports-adm-excel-schedule.php?tgl1=<?php echo $tglawal; ?>&amp;tgl2=<?php echo $tglakhir; ?>&amp;shift=<?php echo $shft; ?>&amp;jenis=<?php echo $jns; ?>'"
        class="art-button" />
    <br />
    <strong><br />
    </strong>
        ...
        <table width="100%" border="1" id="datatables" class="display">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div align="center">
                            <font size="-2"><?php echo strtotime(cek($rowd['tgl_in'], 'Y-m-d')); ?></font>
                        </div>
                    </td>
                    <td>
                        <div align="center">
                            <font size="-2"><?php echo strtotime(cek($rowd['tgl_in'], 'H:i')); ?></font>
                        </div>
                    </td>
                    <td>
                        <div align="center">
                    ...
                    <td>
                        <div align="center">
                            <font size="-2">
                                <?php
                                        $q_namamesin = sqlsrv_query($con, "SELECT * FROM db_brushing.tbl_namamesin WHERE id='$rowd[nama_mesin]'");
                                        $row_namamesin = sqlsrv_fetch_array($q_namamesin);
                    ...
                    <td>
                        ...
                        <input type="button" name="ubah2" id="ubah2" value="ubah"
                            onclick="confirmEdit('?p=edit-report-schedule&id=<?= $rowd['idp']; ?>')" />
                    </td>
                </tr>
                <?php
