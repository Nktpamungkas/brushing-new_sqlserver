	...
	proses,perbaikan ORDER BY proses ASC ");
      ...
      ?>
        <tr style="border:1px solid;" bgcolor="<?php echo $bgcolor; ?>">
          ...
          <td style="border:1px solid;">
            <div align="right"><strong><?php echo $tqt = $rowR['qtyRL'] + $rowR['qtyRL1'] + $rowR['qtyRB'] + $rowR['qtyRB1']; ?></strong></div>
          </td>
          <td style="border:1px solid;">
          ...
          <td style="border:1px solid;">
            <div align="right"><strong><?php echo $tqtadidas = $rowR['qtyRLadidas'] + $rowR['qtyRLadidas1'] + $rowR['qtyRBadidas'] + $rowR['qtyRBadidas1']; ?></strong></div>
          </td>
        </tr>
      <?php
      ...
      <tr style="border:1px solid;">
        ...
        <td bgcolor="#99FF99" style="border:1px solid;">
          <div align="right"><strong><?php echo $totalqt = $totqtyRB + $totqtyRB1 + $totqtyRL + $totqtyRL1; ?></strong></div>
        </td>
        <td bgcolor="#99FF99" style="border:1px solid;">
        ...
        <td bgcolor="#99FF99" style="border:1px solid;">
          <div align="right"><strong><?php echo $totalqtyadidas = $totqtyRBadidas + $totqtyRLadidas + $totqtyRBadidas1 + $totqtyRLadidas1; ?></strong></div>
        </td>
      </tr>
    </table>
    <table width="100%" border="0">
...
GROUP BY
	k_r");
      ...
      <tr bgcolor="#99FF99" style="border:1px solid;">
        ...
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $trb = $rx['RB'] + $r0x['RB'] + $r1x['RB'] + $r2x['RB'] + $r3x['RB'] + $r4x['RB'] + $r5x['RB'] + $r6x['RB']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right">
        ...
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $trl = $rx['RL'] + $r0x['RL'] + $r1x['RL'] + $r2x['RL'] + $r3x['RL'] + $r4x['RL'] + $r5x['RL'] + $r6x['RL']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right"> <strong><?php echo $tqrl = $rx['qtyRL'] + $r0x['qtyRL'] + $r1x['qtyRL'] + $r2x['qtyRL'] + $r3x['qtyRL'] + $r4x['qtyRL'] + $r5x['qtyRL'] + $r6x['qtyRL']; ?> </strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $trb1 = $rx['RB1'] + $r0x['RB1'] + $r1x['RB1'] + $r2x['RB1'] + $r3x['RB1'] + $r4x['RB1'] + $r5x['RB1'] + $r6x['RB1']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right"> <strong><?php echo $tqrb1 = $rx['qtyRB1'] + $r0x['qtyRB1'] + $r1x['qtyRB1'] + $r2x['qtyRB1'] + $r3x['qtyRB1'] + $r4x['qtyRB1'] + $r5x['qtyRB1'] + $r6x['qtyRB1']; ?> </strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $trl1 = $rx['RL1'] + $r0x['RL1'] + $r1x['RL1'] + $r2x['RL1'] + $r3x['RL1'] + $r4x['RL1'] + $r5x['RL1'] + $r6x['RL1']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right"> <strong><?php echo $tqrl1 = $rx['qtyRL1'] + $r0x['qtyRL1'] + $r1x['qtyRL1'] + $r2x['qtyRL1'] + $r3x['qtyRL1'] + $r4x['qtyRL1'] + $r5x['qtyRL1'] + $r6x['qtyRL1']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
        ...
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $trbadidas = $rx['RBadidas'] + $r0x['RBadidas'] + $r1x['RBadidas'] + $r2x['RBadidas'] + $r3x['RBadidas'] + $r4x['RBadidas'] + $r5x['RBadidas'] + $r6x['RBadidas']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right"> <strong><?php echo $tqrbadidas = $rx['qtyRBadidas'] + $r0x['qtyRBadidas'] + $r1x['qtyRBadidas'] + $r2x['qtyRBadidas'] + $r3x['qtyRBadidas'] + $r4x['qtyRBadidas'] + $r5x['qtyRBadidas'] + $r6x['qtyRBadidas']; ?> </strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $trladidas = $rx['RLadidas'] + $r0x['RLadidas'] + $r1x['RLadidas'] + $r2x['RLadidas'] + $r3x['RLadidas'] + $r4x['RLadidas'] + $r5x['RLadidas'] + $r6x['RLadidas']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right"> <strong><?php echo $tqrladidas = $rx['qtyRLadidas'] + $r0x['qtyRLadidas'] + $r1x['qtyRLadidas'] + $r2x['qtyRLadidas'] + $r3x['qtyRLadidas'] + $r4x['qtyRLadidas'] + $r5x['qtyRLadidas'] + $r6x['qtyRLadidas']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $trbadidas1 = $rx['RBadidas1'] + $r0x['RBadidas1'] + $r1x['RBadidas1'] + $r2x['RBadidas1'] + $r3x['RBadidas1'] + $r4x['RBadidas1'] + $r5x['RBadidas1'] + $r6x['RBadidas1']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right"> <strong><?php echo $tqrbadidas1 = $rx['qtyRBadidas1'] + $r0x['qtyRBadidas1'] + $r1x['qtyRBadidas1'] + $r2x['qtyRBadidas1'] + $r3x['qtyRBadidas1'] + $r4x['qtyRBadidas1'] + $r5x['qtyRBadidas1'] + $r6x['qtyRBadidas1']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $trladidas1 = $rx['RLadidas1'] + $r0x['RLadidas1'] + $r1x['RLadidas1'] + $r2x['RLadidas1'] + $r3x['RLadidas1'] + $r4x['RLadidas1'] + $r5x['RLadidas1'] + $r6x['RLadidas1']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right"> <strong><?php echo $tqrladidas1 = $rx['qtyRLadidas1'] + $r0x['qtyRLadidas1'] + $r1x['qtyRLadidas1'] + $r2x['qtyRLadidas1'] + $r3x['qtyRLadidas1'] + $r4x['qtyRLadidas1'] + $r5x['qtyRLadidas1'] + $r6x['qtyRLadidas1']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
        ...
        <td style="border:1px solid;">
          <div align="right"> <strong><?php echo $toqadidas = $tqrbadidas + $tqrladidas + $tqrbadidas1 + $tqrladidas1; ?></strong></div>
        </td>
      </tr>
    </table>
    <table width="100%" border="0">
...
WHERE
	" . $tgl . $shift . " AND b.kapasitas > '1000' and b.kapasitas <= '1200' AND a.qty > 0 ");
      ...
      <tr bgcolor="#99FF99" style="border:1px solid;">
        ...
        <td style="border:1px solid;">
          <div align="center"> <strong><?php echo $ttlRL = $r0['RL'] + $r50['RL'] + $r100['RL'] + $r200['RL'] + $r400['RL'] + $r600['RL'] + $r800['RL'] + $r1000['RL']; ?> </strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right">
            <strong><?php echo $ttlair = $r0['air'] + $r50['air'] + $r100['air'] + $r200['air'] + $r400['air'] + $r600['air'] + $r800['air'] + $r1000['air']; ?> </strong>
          </div>
        </td>
        <td style="border:1px solid;">
          <div align="right"> <strong><?php echo $ttlqty = $r0['qty'] + $r50['qty'] + $r100['qty'] + $r200['qty'] + $r400['qty'] + $r600['qty'] + $r800['qty'] + $r1000['qty']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $ttlloading = $r0['loading'] + $r50['loading'] + $r100['loading'] + $r200['loading'] + $r400['loading'] + $r600['loading'] + $r800['loading'] + $r1000['loading']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $ttll_r = $l_r0 + $l_r50 + $l_r100 + $l_r200 + $l_r400 + $l_r600 + $l_r800 + $l_r1000; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"> <strong><?php echo $ttlRBadidas = $r0['RBadidas'] + $r50['RBadidas'] + $r100['RBadidas'] + $r200['RBadidas'] + $r400['RBadidas'] + $r600['RBadidas'] + $r800['RBadidas'] + $r1000['RBadidas']; ?> </strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"> <strong><?php echo $ttlRLadidas = $r0['RLadidas'] + $r50['RLadidas'] + $r100['RLadidas'] + $r200['RLadidas'] + $r400['RLadidas'] + $r600['RLadidas'] + $r800['RLadidas'] + $r1000['RLadidas']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right"> <strong><?php echo $ttlairadidas = $r0['air'] + $r50['airadidas'] + $r100['airadidas'] + $r200['airadidas'] + $r400['airadidas'] + $r600['airadidas'] + $r800['airadidas'] + $r1000['airadidas']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="right"> <strong><?php echo $ttlqtyadidas = $r0['qtyadidas'] + $r50['qtyadidas'] + $r100['qtyadidas'] + $r200['qtyadidas'] + $r400['qtyadidas'] + $r600['qtyadidas'] + $r800['qtyadidas'] + $r1000['qtyadidas']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $ttlloadingadidas = $r0['loading'] + $r50['loadingadidas'] + $r100['loadingadidas'] + $r200['loadingadidas'] + $r400['loadingadidas'] + $r600['loadingadidas'] + $r800['loadingadidas'] + $r1000['loadingadidas']; ?></strong></div>
        </td>
        <td style="border:1px solid;">
          <div align="center"><strong><?php echo $ttll_radidas = $l_radidas0 + $l_radidas50 + $l_radidas100 + $l_radidas200 + $l_radidas400 + $l_radidas600 + $l_radidas800 + $l_radidas1000; ?></strong></div>
        </td>
      </tr>
      <tr bgcolor="#99FF99" style="border:1px solid;">
        <td style="border:1px solid;">&nbsp;</td>
...
GROUP BY energi ORDER BY energi ASC");
            ...
            <tr bgcolor="#99FF99" style="border:1px solid;">
              ...
              <td style="border:1px solid;">
                <div align="right"><strong><?php echo $Ejamradidas . " Jam " . $Emenitradidas . " Menit"; ?></strong></div>
              </td>
              <td style="border:1px solid;">
...
GROUP BY kd_stop ORDER BY kd_stop ASC ");
            ...
            <tr bgcolor="#99FF99" style="border:1px solid;">
              ...
              <td style="border:1px solid;">
                <div align="right"> <strong><?php echo $ttlMadidas = $rSM['lamaadidas'] + $rCO['lamaadidas'] + $rBD['lamaadidas'] + $rOL['lamaadidas'] + $rQC['lamaadidas'] + $rPL['lamaadidas']; ?> </strong></div>
              </td>
            </tr>
            <tr bgcolor="#99FF99" style="border:1px solid;">
              <td style="border:1px solid;">&nbsp;</td>
