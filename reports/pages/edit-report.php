...
<body>
  ...
  if (isset($_POST['simpan'])) {
    $sqlubah = sqlsrv_query($con, "UPDATE db_brushing.tbl_adm SET
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="90%"><select name="shift" id="shift" required>
                            ...
                            <option value="A" <?php if ($rw['shift_out'] == "A") {
                echo "selected";
              } ?>>A</option>
                            <option value="B" <?php if ($rw['shift_out'] == "B") {
                echo "selected";
              } ?>>B</option>
                            <option value="C" <?php if ($rw['shift_out'] == "C") {
                echo "selected";
              } ?>>C</option>
                        </select></td>
                </tr>
                <tr>
                    ...
                    <td><select name="shift2" id="shift2" required>
                            <option value="">Pilih</option>
                            <option value="1" <?php if ($rw['shift1_out'] == "Pagi") {
                echo "selected";
              } ?>>Pagi</option>
                            <option value="2" <?php if ($rw['shift1_out'] == "Siang") {
                echo "selected";
              } ?>>Siang</option>
                            <option value="3" <?php if ($rw['shift1_out'] == "Malam") {
                echo "selected";
              } ?>>Malam</option>
                        </select></td>
                </tr>
