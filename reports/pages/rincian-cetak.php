...
<body>
  ...
  if ($tglakhir != "" and $tglawal != "") {
    $tgl = " CONVERT(VARCHAR(16), tgl_update, 120)  BETWEEN '$tglawal' AND '$tglakhir' ";
  } else {
    $tgl = " ";
  }
  if ($shft == "ALL") {
                ...
                <td>
                    <table width="100%" border="0">
                        <tr style="border:1px solid; font-size:12px;">
                            <td width="6%" rowspan="4" style="border:1px solid; font-size:12px;"><img src="Indo.jpg"
            ...
            while ($rowR = sqlsrv_fetch_array($sqlR)) {
              ...
              ?>
                        <tr bgcolor="<?php echo $bgcolor; ?>">
                            ...
                            <td>
                                <div align="center"><strong><?php echo $trb = $rowR['RB'] + $rowR['RB1']; ?></strong>
                                </div>
                            </td>
                            <td>
                                <div align="center"><strong><?php echo $trl = $rowR['RL'] + $rowR['RL1']; ?></strong>
                                </div>
                            </td>
                            <td>
                                <div align="right">
                            ...
                            <td>
                                <div align="center">
                                    <strong><?php echo $trbadidas = $rowR['RBadidas'] + $rowR['RBadidas1']; ?></strong>
                                </div>
                            </td>
                            <td>
                                <div align="center">
                                    <strong><?php echo $trladidas = $rowR['RLadidas'] + $rowR['RLadidas1']; ?></strong>
                                </div>
                            </td>
                            <td>
                                <div align="right">
              ...
              $no++;
                        ...
                        <tr>
                            ...
                            <td bgcolor="#99FF99">
                                <div align="center">
                                    <strong><?php echo $totalrbadidas = $totRBadidas + $totRBadidas1; ?></strong>
                                </div>
                            </td>
                            <td bgcolor="#99FF99">
                                <div align="center">
                                    <strong><?php echo $totalrladidas = $totRLadidas + $totRLadidas1; ?></strong>
                                </div>
                            </td>
                            <td bgcolor="#99FF99">
                                <div align="right">
                    ...
                    <table width="100%" border="0" class="table-list1">
                        ...
                        <?php
            $sqlx = sqlsrv_query($con, "SELECT k_r,
...
GROUP BY
	k_r");
            ...
            $sql0x = sqlsrv_query($con, "SELECT k_r,
	sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RB',
  sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRB',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RL',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRL',
...
GROUP BY
	k_r");
            ...
            $sql1x = sqlsrv_query($con, "SELECT k_r,
	sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RB',
  sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRB',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RL',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRL',
...
GROUP BY
	k_r");
            ...
            $sql2x = sqlsrv_query($con, "SELECT k_r,
	sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RB',
  sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRB',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RL',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRL',
...
GROUP BY
	k_r");
            ...
            $sql3x = sqlsrv_query($con, "SELECT k_r,
	sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RB',
  sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRB',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RL',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRL',
...
GROUP BY
	k_r");
            ...
            $sql4x = sqlsrv_query($con, "SELECT k_r,
	sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RB',
  sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRB',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RL',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRL',
...
GROUP BY
	k_r");
            ...
            $sql5x = sqlsrv_query($con, "SELECT k_r,
	sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RB',
  sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRB',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RL',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRL',
...
GROUP BY
	k_r");
            ...
            $sql6x = sqlsrv_query($con, "SELECT k_r,
	sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RB',
  sum(IF(rb_rl = 'R.B' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRB',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', 1, 0)) AS 'RL',
	sum(IF(rb_rl = 'R.L' and qty > 200 and proses='Celup Greige', qty, 0)) AS 'qtyRL',
                    ...
                    echo "0.00";
                      ...
                      echo "0.00";
                        ...
                        <tr bgcolor="#99FF99">
                            ...
                            <td>
                                <div align="right">
                                    <strong><?php echo $toq = $tqrb + $tqrl + $tqrb1 + $tqrl1; ?></strong>
                                </div>
                            </td>
                            <td>
                                <div align="center">
                            ...
                            <td>
                                <div align="center">
                                    <strong><?php echo $torbadidas1 = $trbadidas + $trbadidas1; ?></strong>
                                </div>
                            </td>
                            <td>
                                <div align="center">
                                    <strong><?php echo $torladidas1 = $trladidas + $trladidas1; ?></strong>
                                </div>
                            </td>
                            <td>
                                <div align="right">
...
LEFT JOIN db_brushing.tbl_mesin b ON a.no_mesin=b.no_mesin
WHERE
...
WHERE
	" . $tgl . $shift . " AND b.kapasitas > '800' and b.kapasitas <= '1000' AND a.qty > 0");
            ...
            $sql1000 = sqlsrv_fetch_array($con, "SELECT
  ROUND(AVG(a.air)) as 'air',
	ROUND(AVG(a.qty),2) AS 'qty',
  ROUND(AVG((a.qty/b.kapasitas)*100),2) as `loading`,
  ROUND(AVG(a.air/a.qty),2) as `l_r`,
            ...
            ?>
                    ...
                    echo "0";
                        ...
                        <tr bgcolor="#99FF99">
                            ...
                            <td>
                                <div align="center"><strong><?php echo round($ttlloadingadidas / 8, 2); ?></strong>
                                </div>
                            </td>
                            <td>
                  ...
                  while ($rng = sqlsrv_fetch_array($sqlenergi)) {
                    ...
                    $n++;
                                    ...
                                    <tr bgcolor="#99FF99">
                                        ...
                                        <td>
                                            <div align="right">
                                                <strong><?php echo $Ejam . " Jam " . $Emenit . " Menit"; ?></strong>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div align="right"><strong><?php echo round($ttlLamaEadidas); ?></strong>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr bgcolor="#99FF99">
                                        ...
                                        <td>
                                            <div align="right">
                                                <strong><?php echo $Ejamr . " Jam " . $Emenitr . " Menit"; ?></strong>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div align="right"><strong><?php echo round($ttlLamaEradidas); ?></strong>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                  ...
                  ?>
                        ...
                        echo $jam . " Jam " . $menit . " Menit"; ?>
                          ...
                          echo $ttljamr . " Jam " . $ttlmenitr . " Menit"; ?>
                                        ...
                                        <td>
                                            <div align="right"><strong><?php echo round($ttlMenit / 6); ?></strong>
                                            </div>
                                        </td>
                                        <td>
                                            <div align="right">
                          ...
                          echo $ttljamadidasr . " Jam " . $ttlmenitadidasr . " Menit"; ?>
                                        ...
                                        <td>
                                            <div align="right"><strong><?php echo round($ttlmadidas / 6); ?></strong>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
