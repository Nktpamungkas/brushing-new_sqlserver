  ...
  if ($_POST['jenis'] == "Harian" or $_GET['jenis'] == "Harian") {
    ...
    WHERE tgl_update='$tgl' AND shift='A'");
              ...
              ?>
                ...
                <td><?php if ($rA['Garuk Fleece'] > 0) {
              echo $rA['Garuk Fleece'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rA['Potong Bulu Fleece'] > 0) {
              echo $rA['Potong Bulu Fleece'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rA['Garuk Anti Pilling'] > 0) {
              echo $rA['Garuk Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rA['Sisir Anti Pilling'] > 0) {
              echo $rA['Sisir Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rA['Potong Bulu Anti Pilling'] > 0) {
              echo $rA['Potong Bulu Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rA['Anti Pilling'] > 0) {
              echo $rA['Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rA['Peach Skin'] > 0) {
              echo $rA['Peach Skin'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rA['Potong Bulu Peach Skin'] > 0) {
              echo $rA['Potong Bulu Peach Skin'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rA['Airo'] > 0) {
              ...
              echo "-";
                ...
                <td>
                    <?php if ($rA['Potong Bulu Lain-Lain Bantu Khusus'] > 0) {
                echo $rA['Potong Bulu Lain-Lain Bantu Khusus'];
              } else {
                echo "-";
              } ?>
                </td>
                <td><?php if ($rA['Potong Bulu Lain-Lain Bantu'] > 0) {
              echo $rA['Potong Bulu Lain-Lain Bantu'];
            } else {
              echo "-";
            } ?>
                </td>
    ...
    WHERE tgl_update='$tgl' AND shift='B'");
              ...
              ?>
                ...
                <td><?php if ($rB['Garuk Fleece'] > 0) {
              echo $rB['Garuk Fleece'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rB['Potong Bulu Fleece'] > 0) {
              echo $rB['Potong Bulu Fleece'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rB['Garuk Anti Pilling'] > 0) {
              echo $rB['Garuk Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rB['Sisir Anti Pilling'] > 0) {
              echo $rB['Sisir Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rB['Potong Bulu Anti Pilling'] > 0) {
              echo $rB['Potong Bulu Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rB['Anti Pilling'] > 0) {
              echo $rB['Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rB['Peach Skin'] > 0) {
              echo $rB['Peach Skin'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rB['Potong Bulu Peach Skin'] > 0) {
              echo $rB['Potong Bulu Peach Skin'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rB['Airo'] > 0) {
              ...
              echo "-";
                ...
                <td>
                    <?php if ($rB['Potong Bulu Lain-Lain Bantu Khusus'] > 0) {
                echo $rB['Potong Bulu Lain-Lain Bantu Khusus'];
              } else {
                echo "-";
              } ?>
                </td>
                <td><?php if ($rB['Potong Bulu Lain-Lain Bantu'] > 0) {
              echo $rB['Potong Bulu Lain-Lain Bantu'];
            } else {
              echo "-";
            } ?>
                </td>
    ...
    WHERE tgl_update='$tgl' AND shift='C'");
              ...
              ?>
                ...
                <td><?php if ($rC['Garuk Fleece'] > 0) {
              echo $rC['Garuk Fleece'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rC['Potong Bulu Fleece'] > 0) {
              echo $rC['Potong Bulu Fleece'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rC['Garuk Anti Pilling'] > 0) {
              echo $rC['Garuk Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rC['Sisir Anti Pilling'] > 0) {
              echo $rC['Sisir Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rC['Potong Bulu Anti Pilling'] > 0) {
              echo $rC['Potong Bulu Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rC['Anti Pilling'] > 0) {
              echo $rC['Anti Pilling'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rC['Peach Skin'] > 0) {
              echo $rC['Peach Skin'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rC['Potong Bulu Peach Skin'] > 0) {
              echo $rC['Potong Bulu Peach Skin'];
            } else {
              echo "-";
            } ?></td>
                <td><?php if ($rC['Airo'] > 0) {
              ...
              echo "-";
                ...
                <td>
                    <?php if ($rC['Potong Bulu Lain-Lain Bantu Khusus'] > 0) {
                echo $rC['Potong Bulu Lain-Lain Bantu Khusus'];
              } else {
                echo "-";
              } ?>
                </td>
                <td><?php if ($rC['Potong Bulu Lain-Lain Bantu'] > 0) {
              echo $rC['Potong Bulu Lain-Lain Bantu'];
            } else {
              echo "-";
            } ?>
                </td>
