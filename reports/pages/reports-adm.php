        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td><input type="button" name="hapus" id="hapus" value="Hapus" onClick="confirmDelete('?p=hapus-report-adm&id=<?php echo $rowd['idp']; ?>&tgl1=<?php echo $tglawal; ?>&tgl2=<?php echo $tglakhir; ?>&shift=<?php echo $shft; ?>&jenis=Kartu IN');" />
                <input type="button" name="ubah2" id="ubah2" value="ubah" onclick="confirmEdit('?p=edit-in-report&amp;id=<?php echo $rowd['idp']; ?>&amp;tgl1=<?php echo $tglawal; ?>&amp;tgl2=<?php echo $tglakhir; ?>&amp;shift=<?php echo $shft; ?>&amp;jenis=Kartu OUT');" />
              </td>
            </tr>
          <?php
