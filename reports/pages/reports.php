...
//    }
    ...
    <form id="form1" name="form1" method="post" action="">
        ...
        <table width="100%" border="1" id="datatables" class="display">
          ...
          $sql = sqlsrv_query($con, "SELECT *,a.id as idp FROM db_brushing.tbl_produksi a
...
//    }
    if ($tglakhir != "" and $tglawal != "" and $jamakhir != "" and $jamawal != "") {
      $tgl = "  CONVERT(VARCHAR(16), tgl_buat, 120)  BETWEEN '$tglawal $jamawal' AND '$tglakhir $jamakhir' ";
    } else {
      $tgl = " ";
    }
    if ($shft == "ALL") {
