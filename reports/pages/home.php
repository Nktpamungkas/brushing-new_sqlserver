          ...
          echo $tgl; ?><br />
            ...
            <tr>
                ...
                <td><label for="jns"></label>
                    <select name="jns" id="jns" onchange="ganti();">
                        <option value="Produksi Brushing" selected>Produksi Brushing</option>
            ...
            if (time.match(/^\d{2}$/) !== null) {
              ...
              this.value = time + '';
                    ...
                    <input name="awal" type="text" id="awal"
            ...
            <tr>
                <td colspan="3"><input type="submit" name="button" id="button" value="Lihat Data" class="art-button" />
                    <input type="button" name="button2" id="button2" value="Kembali"
                        onclick="window.location.href='../index.php'" class="art-button" /></td>
            </tr>
        </table>
    </form>
</body>
