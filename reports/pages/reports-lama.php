...
WHERE
	".$tgl.$shift.$mesin." ORDER BY a.`no_mesin` ASC ";
...
<div align="right">Halaman Ke :
	...
	for ($h = 1; $h <= $max; $h++) {
		$list[$h] = $row * $h - $row;
		echo " <a href='?p=reports&shift=$shft&tgl1=$tglawal&tgl2=$tglakhir&jns=$jns&hal=$list[$h]'>$h</a> ";
	}
	?>
  </div>
  ...
  <table width="100%" border="0" >
    <tr style="border:1px solid;">
      <td rowspan="2" bgcolor="#99FF99" style="border:1px solid; vertical-align:middle;"><div align="center"><strong><font size="-2">NO.</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99" style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">NO MC</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99" style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">LANGGANAN / BUYER</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99" style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">NO ORDER</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99" style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">JENIS KAIN</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99" style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">WARNA</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99" style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">LOT</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99" style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">ROLL</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99"style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">QTY</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99"style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">PROSES</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99"style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">KETERANGAN</font></strong></div></td>
      <td colspan="2" bgcolor="#99FF99" style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">JAM PROSES</font></strong></div></td>
      <td colspan="2" bgcolor="#99FF99" style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">STOP MESIN</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99" style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">TOTAL STOP</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99" style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">KODE STOP</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99"style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">SHIFT</font></strong></div></td>
      <td rowspan="2" bgcolor="#99FF99"style="border:1px solid;vertical-align:middle;"><div align="center"><strong><font size="-2">AKSI</font></strong></div></td>
    </tr>
    <tr style="border:1px solid;">
      <td bgcolor="#99FF99"style="border:1px solid;"><div align="center"><strong><font size="-2">IN</font></strong></div></td>
      <td bgcolor="#99FF99"style="border:1px solid;"><div align="center"><strong><font size="-2">OUT</font></strong></div></td>
      <td bgcolor="#99FF99"style="border:1px solid;"><div align="center"><strong><font size="-2">JAM</font></strong></div></td>
      <td bgcolor="#99FF99"style="border:1px solid;"><div align="center"><strong><font size="-2">S/D</font></strong></div></td>
    </tr>
    <?php 
...
WHERE
	".$tgl.$shift.$mesin.$nomesin." ORDER BY a.`no_mesin` ASC LIMIT $hal, $row");
   if($hal>0){
   $no=$hal+1;}else
   {$no=1;}
   ...
   $c=0;
    while($rowd=mysql_fetch_array($sql)){
      ...
      <td style="border:1px solid;"><div align="center"><font size="-2"><?php echo $rowd['no_mesin'];?></font></div></td>
      ...
      <td style="border:1px solid;"><font size="-2"><?php echo $rowd['ket']; ?></font></td>
      <td style="border:1px solid;"><div align="center"><font size="-2"><?php echo $rowd['jam_in']; ?></font></div></td>
      <td style="border:1px solid;"><div align="center"><font size="-2"><?php echo $rowd['jam_out'];?></font></div></td>
      <td style="border:1px solid;"><div align="center"><font size="-2"><?php echo $rowd['stop_l'];?></font></div></td>
      <td style="border:1px solid;"><div align="center"><font size="-2"><?php echo $rowd['stop_r'];?></font></div></td>
      ...
      <td style="border:1px solid;"><div align="center"><font size="-2"><?php echo $rowd['kd_stop'];?></font></div></td>
      ...
      <td style="border:1px solid;"><input type="button" name="hapus" id="hapus" value="Hapus" onClick="confirmDelete('?p=hapus-report&id=<?php echo $rowd[idp];?>&tgl1=<?php echo $tglawal;?>&tgl2=<?php echo $tglakhir;?>&shift=<?php echo $shft;?>&jns=Produksi Brushing&nama_mesin=<?php echo $rowd['nama_mesin'];?>&no_mesin=<?php echo $rowd['no_mesin'];?>');"/>
        <input type="button" name="ubah" id="ubah" value="Ubah" onclick="window.location.href='../data-brushing/?p=&amp;id=<?php echo $rowd[idp];?>';"/></td>
    </tr>
     <?php 
    ...
    <tr style="border:1px solid;">
      <td colspan="5" bgcolor="#99FF99"><strong>Jumlah Data : <?php echo $jml; ?>
      </strong></td>
      <td bgcolor="#99FF99"><strong>Total</strong></td>
      <td bgcolor="#99FF99"><strong><?php echo $totcones;?></strong></td>
