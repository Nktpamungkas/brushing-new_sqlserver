    ...
    while ($rowd = sqlsrv_fetch_array($sql, SQLSRV_FETCH_ASSOC)) {
      ?>
        <tr valign="top">
          ...
          echo cek($rowd['tgl_proses_in']);
        } ?></td>
            <td><?php echo $rowd['jam_in']; ?></td>
            <td><?php if ($rowd['jam_out'] != "") {
          echo cek($rowd['tgl_proses_out']);
        } ?></td>
            <td><?php echo $rowd['jam_out']; ?></td>
            <td><?php
        date_default_timezone_set('Asia/Jakarta');
        $time3 = strtotime(cek($rowd['tgl_proses_in']) . " " . $rowd['jam_in']);
        $time4 = strtotime(cek($rowd['tgl_proses_out']) . " " . $rowd['jam_out']);
        $diff1 = $time4 - $time3;
        ...
        ?></td>
          ...
          echo $rowd['stop_r'];
            ...
            <td><?php
        date_default_timezone_set('Asia/Jakarta');
        $time1 = strtotime(cek($rowd['tgl_stop_l']) . " " . $rowd['stop_l']);
        $time2 = strtotime(cek($rowd['tgl_stop_r']) . " " . $rowd['stop_r']);
        $diff = $time2 - $time1;
        ...
        ?></td>
            ...
            <td><?php
        date_default_timezone_set('Asia/Jakarta');
        $ptime1 = strtotime(cek($rowd['tgl_proses_in']) . " " . $rowd['jam_in']);
        $ptime2 = strtotime(cek($rowd['tgl_proses_out']) . " " . $rowd['jam_out']);
        $pdiff = $ptime2 - $ptime1;
