...
<head>
	...
	<title>Cetak Form Identifikasi produk</title>
	<script>
...
left join TM.dbo.SalesOrders on TM.dbo.SalesOrders.ID= TM.dbo.SODetails.SOID
		...
		//
		$sqlsmp = mysqli_query($con,"select now() as tgl_skrng ");
	...
	border-right:1px #000000 solid;">&nbsp;</td>
				...
				<tr>
					...
					<td>: <?php echo date("d-M-Y H:i:s", strtotime($rowsmp['tgl_skrng'])); ?></td>
				</tr>
				<tr>
					<td style="height: 0.3in;">NO. ORDER</td>
					<td>:
						<?php if ($ssr['documentno'] != "") {
						...
						<table width="100%" border="0">
							<tbody>
								<tr align="left" valign="top">
									<td width="23%" style="height: 0.4in;" scope="col">1. <input name="g1" type="text" placeholder="Ketik disini" size="10" /></td>
									<td width="20%" scope="col">2. <input name="g2" type="text" id="g2" placeholder="" size="10" /></td>
									<td width="18%" scope="col">3. <input name="g3" type="text" id="g3" placeholder="" size="10" /></td>
									<td width="19%" scope="col">4. <input name="g4" type="text" id="g4" placeholder="" size="10" /></td>
									<td width="20%" scope="col">5. <input name="g5" type="text" id="g5" placeholder="" size="10" /></td>
								</tr>
							</tbody>
						</table>
					</td>
