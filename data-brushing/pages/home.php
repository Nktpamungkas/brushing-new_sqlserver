			...
			<tr>
				...
				<td>
					...
					<input name="buyer" type="text" id="buyer" size="45"
						value="<?php if(!empty($rw['langganan'])){ echo $rw['langganan']; }else{ echo $langganan_buyer;} ?>" />
				</td>
				<td>
					<h4>Tgl Brushing</h4>
				</td>
			...
			<tr>
              ...
              $no_order = $rwAdm['no_order'];
					...
					<input type="text" name="no_order" id="no_order"
						value="<?php if(!empty($rw['no_order'])){ echo $rw['no_order'];}else{ echo $no_order; } ?>" />
				</td>
				<td>
					<h4>Proses</h4>
				</td>
			...
			<tr>
              ...
              $jk = $rwAdm['jenis_kain'];
					...
					<textarea name="jenis_kain" cols="35"
						id="jenis_kain"><?php if(!empty($rw['jenis_kain'])){ echo $rw['jenis_kain'];}else{ echo $jk; } ?></textarea>
				</td>
				<td valign="top">
					<h4>Keterangan</h4>
				</td>
