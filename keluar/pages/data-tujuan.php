...
<body>
  ...
  if (isset($_POST['btnHapus'])) {
    $hapusSql = "DELETE FROM db_brushing.tbl_tujuan WHERE id='$_POST[id]'";
  ...
  if (isset($_POST['btnSimpan'])) {
    ...
    $simpanSql = "INSERT INTO db_brushing.tbl_tujuan SET 
	tujuan='$tujuan',
	ket='$ket'";
  ...
  if (isset($_POST['btnUbah'])) {
    $tujuan = $_POST['tujuan'];
    $ket = str_replace("'", "", $_POST['ket']);
    $simpanSql = "UPDATE db_brushing.tbl_tujuan SET 
	tujuan='$tujuan',
	ket='$ket'
	WHERE id='$_POST[id]'";
  ...
  <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
    <table width="100%" border="0">
      ...
      <?php $qtampil = sqlsrv_query($con,"SELECT TOP 1 * FROM db_brushing.tbl_tujuan WHERE tujuan='$_GET[tujuan]'",array(), array("Scrollable" => SQLSRV_CURSOR_KEYSET));
    ...
    <table width="100%" border="0">
      ...
      <?php
      $qry = sqlsrv_query($con,"SELECT * FROM db_brushing.tbl_tujuan ORDER BY id ASC");
      $no = 1;
