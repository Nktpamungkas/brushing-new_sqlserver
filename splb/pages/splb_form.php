...
<script type="text/javascript">
        ...
        //     // Jika sisa pembagian dengan 1 adalah 0, berarti tidak ada desimal, return sebagai integer
        //     if (value % 1 === 0) {
        //         return parseInt(value);
        //     } else {
        //         // Jika ada desimal, return sebagai nilai asli
        //         return value;
        //     }
        // }
...
if ($idkk != "") {
        ...
        $qry = sqlsrv_query(
                $con,
                "SELECT TOP 1 * FROM db_brushing.tbl_adm 
		WHERE nokk = ? AND status = '1' AND tgl_out IS NULL 
		ORDER BY id DESC",
                array($idkk),
                                ...
                                <table class="table table-bordered">
                                        ...
                                        <tbody>
                                                        ...
                                                        <td class="bg-warning" data-no="2" colspan="8">
                                                                <div class="form-inline text-center">
                                                                        <input type="text" class="form-control input-xs"
                                                                                name="NO_KARTU_KERJA"
                                                                                id="NO_KARTU_KERJA"
                                                                                value="<?php echo $_POST['kk'] ?>"
                                                                                readonly>/</span>
                                                                        <input type="text" class="form-control input-xs"
                                                                                name="DEAMAND" id="DEAMAND"
                                                                                value="<?php echo $_POST['DEAMAND'] ?>"
                                                                                style="width: 100%" readonly>
                                                        </td>
                                                        <td data-no="10" colspan="7" style="text-align: center;">
                                                                SPV/ASST/LDR</td>
                                                </tr>
                                                <tr class="baris">
                                                        <td style="width: 180px;" data-no="1">LANGGANAN</td>
                                                        <td class="bg-warning" data-no="2" colspan="8"><input
                                                                        type="text" class="form-control input-xs"
                                                                        readonly required name="LANGGANAN"
                                                                        id="LANGGANAN" value="<?php if ($cek > 0) {
                                                                                echo $ssr1['partnername'] . "/" . $ssr2['partnername'];
                                                                        } else {
                                                                                echo $rw['langganan'];
                                                                        } ?>" style="width: 100%;"></td>
                                                        <td data-no="10" colspan="7" class="bg-warning"><input
                                                                        type="text" class="form-control input-xs"
                                                                        readonly name="TANGGAL_01" id="TANGGAL_01"
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-warning" data-no="2" colspan="8"><input
                                                                        type="text" class="form-control input-xs"
                                                                        readonly name="ORDER" id="ORDER" value="<?php if ($cek > 0) {
                                                                                echo $ssr['documentno'];
                                                                        } else {
                                                                                echo $rw['no_order'];
                                                                        } ?>" style="width: 100%;"></td>
                                                        <td data-no="10" colspan="7" rowspan="6"><textarea name="NOTE"
                                                                        id="NOTE" placeholder="-CATATAN-"
                                                                        style="height: 100%;" class="form-control"
                                                                        rows="9"></textarea></td>
                                                </tr>
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-warning" data-no="2" colspan="8"><input
                                                                        type="text" class="form-control input-xs"
                                                                        readonly name="JENIS_KAIN" id="JENIS_KAIN"
                                                                        value="<?php if ($cek > 0) {
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-warning" data-no="2" colspan="8">
                                                                <div class="form-inline text-center">
                                                                        <input name="L_PERMINTAAN" type="text"
                                                                                id="L_PERMINTAAN" readonly
                                                                        ...
                                                                        &nbsp;
                                                                        <input name="G_PERMINTAAN" type="text"
                                                                                id="G_PERMINTAAN" readonly
                                                                                class="form-control input-xs" value="<?php if ($cek > 0) {
                                                                                        echo $ssr['weight'];
                                                                                } else {
                                                                                        echo $rw['gramasi'];
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-warning" data-no="2" colspan="8"><input
                                                                        type="text" class="form-control input-xs"
                                                                        readonly name="LOT" id="LOT" value="<?php if ($cLot > 0) {
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-warning" data-no="2" colspan="7"
                                                                style="text-align:center;"><input type="text"
                                                                        class="form-control input-xs" name="NAMA_TTD"
                                                                        id="NAMA_TTD">
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td colspan="6" class="bg-danger" style="text-align:center;">OK
                                                        </td>
                                                        <td data-no="10" class="bg-danger" style="text-align:center;">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="OK" id="OK" placeholder="-OK-"
                                                                        style="width: 100%">
                                                        </td>

                                                </tr>
                                                <tr>
                                                        <td data-no="10" colspan="6" class="bg-danger"
                                                                style="text-align:center;">NOT OK</td>
                                                        <td data-no="10" class="bg-danger" style="text-align:center;">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="NOT_OK" id="NOT_OK" placeholder="-NOT_OK-"
                                                                        style="width: 100%">
                                                        </td>
                                                </tr>
                                                ...
                                                <tr>
                                                        <td colspan="2"
                                                                style="text-align: center;font-size: 15px; font-weight: bold;">
                                                                GARUK</td>
                                                        <td class="bg-danger" colspan="1"><input type="text"
                                                                        class="form-control input-xs" name="GARUK"
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-danger" data-no="2"><input type="text"
                                                                        class="form-control input-xs" name="BAG_KAIN_01"
                                                                        id="BAG_KAIN_01" placeholder="-BAGIKAIN-"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="3"><input type="text"
                                                                        class="form-control input-xs" name="BAG_KAIN_02"
                                                                        id="BAG_KAIN_02" placeholder="-BAGIKAIN-"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="4"><input type="text"
                                                                        class="form-control input-xs" name="BAG_KAIN_03"
                                                                        id="BAG_KAIN_03" placeholder="-BAGIKAIN-"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="5"><input type="text"
                                                                        class="form-control input-xs" name="BAG_KAIN_04"
                                                                        id="BAG_KAIN_04" placeholder="-BAGIKAIN-"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="6"><input type="text"
                                                                        class="form-control input-xs" name="BAG_KAIN_05"
                                                                        id="BAG_KAIN_05" placeholder="-BAGIKAIN-"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="7"><input type="text"
                                                                        class="form-control input-xs" name="BAG_KAIN_06"
                                                                        id="BAG_KAIN_06" placeholder="-BAGIKAIN-"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="8"><input type="text"
                                                                        class="form-control input-xs" name="BAG_KAIN_07"
                                                                        id="BAG_KAIN_07" placeholder="-BAGIKAIN-"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="8"><input type="text"
                                                                        class="form-control input-xs" name="BAG_KAIN_08"
                                                                        id="BAG_KAIN_08" placeholder="-BAGIKAIN-"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="10">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="BAG_KAIN_09" id="BAG_KAIN_09"
                                                                        placeholder="-BAGIKAIN-" style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="11">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="BAG_KAIN_10" id="BAG_KAIN_10"
                                                                        placeholder="-BAGIKAIN-" style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="12">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="BAG_KAIN_11" id="BAG_KAIN_11"
                                                                        placeholder="-BAGIKAIN-" style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="13">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="SIKAT04_05" id="SIKAT04_05"
                                                                        placeholder="-BAGIKAIN-" style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="14">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="BAG_KAIN_13" id="BAG_KAIN_13"
                                                                        placeholder="-BAGIKAIN-" style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="15">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="BAG_KAIN_14" id="BAG_KAIN_14"
                                                                        placeholder="-BAGIKAIN-" style="width: 100%">
                                                        </td>
                                                </tr>
                                                <tr class="baris">
                                                        <td style="width: 180px;" data-no="1" colspan="1" rowspan="2">
                                                                COUNTER PILE</td>
                                                        <td data-no="1" colspan="1">1</td>
                                                        <td class="bg-danger" data-no="1"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE1" id="COUNTER_PILE1"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="2"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE2" id="COUNTER_PILE2"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="3"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE3" id="COUNTER_PILE3"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="4"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE4" id="COUNTER_PILE4"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="5"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE5" id="COUNTER_PILE5"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="6"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE6" id="COUNTER_PILE6"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="7"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE7" id="COUNTER_PILE7"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="8"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE8" id="COUNTER_PILE8"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="9"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE9" id="COUNTER_PILE9"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="10"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE10" id="COUNTER_PILE10"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="11"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE11" id="COUNTER_PILE11"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="12"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE12" id="COUNTER_PILE12"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="13"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE13" id="COUNTER_PILE13"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="14"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE14" id="COUNTER_PILE14"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                </tr>
                                                </tr>
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-danger" data-no="15"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE15" id="COUNTER_PILE15"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="16"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE16" id="COUNTER_PILE16"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="17"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE17" id="COUNTER_PILE17"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="18"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE18" id="COUNTER_PILE18"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="19"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE19" id="COUNTER_PILE19"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="20"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE20" id="COUNTER_PILE20"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="21"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE21" id="COUNTER_PILE21"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="22"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE22" id="COUNTER_PILE22"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="23"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE23" id="COUNTER_PILE23"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="24"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE24" id="COUNTER_PILE24"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="25"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE25" id="COUNTER_PILE25"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="26"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE26" id="COUNTER_PILE26"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="27"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE27" id="COUNTER_PILE27"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="28"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="COUNTER_PILE28" id="COUNTER_PILE28"
                                                                        placeholder="-COUNTER PILE-"
                                                                        style="width: 100%"></td>
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td data-no="1" colspan="1">1</td>
                                                        <td class="bg-danger" data-no="1"><input type="text"
                                                                        class="form-control input-xs" name="PILE1"
                                                                        id="PILE1" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="2"><input type="text"
                                                                        class="form-control input-xs" name="PILE2"
                                                                        id="PILE2" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="3"><input type="text"
                                                                        class="form-control input-xs" name="PILE3"
                                                                        id="PILE3" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="4"><input type="text"
                                                                        class="form-control input-xs" name="PILE4"
                                                                        id="PILE4" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="5"><input type="text"
                                                                        class="form-control input-xs" name="PILE5"
                                                                        id="PILE5" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="6"><input type="text"
                                                                        class="form-control input-xs" name="PILE6"
                                                                        id="PILE6" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="7"><input type="text"
                                                                        class="form-control input-xs" name="PILE7"
                                                                        id="PILE7" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="8"><input type="text"
                                                                        class="form-control input-xs" name="PILE8"
                                                                        id="PILE8" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="9"><input type="text"
                                                                        class="form-control input-xs" name="PILE9"
                                                                        id="PILE9" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="10"><input type="text"
                                                                        class="form-control input-xs" name="PILE10"
                                                                        id="PILE10" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="11"><input type="text"
                                                                        class="form-control input-xs" name="PILE11"
                                                                        id="PILE11" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="12"><input type="text"
                                                                        class="form-control input-xs" name="PILE12"
                                                                        id="PILE12" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="13"><input type="text"
                                                                        class="form-control input-xs" name="PILE13"
                                                                        id="PILE13" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="14"><input type="text"
                                                                        class="form-control input-xs" name="PILE14"
                                                                        id="PILE14" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                </tr>
                                                <tr class="baris">
                                                        <td data-no="1" colspan="1">2</td>
                                                        <td class="bg-danger" data-no="15"><input type="text"
                                                                        class="form-control input-xs" name="PILE15"
                                                                        id="PILE15" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="16"><input type="text"
                                                                        class="form-control input-xs" name="PILE16"
                                                                        id="PILE16" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="17"><input type="text"
                                                                        class="form-control input-xs" name="PILE17"
                                                                        id="PILE17" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="18"><input type="text"
                                                                        class="form-control input-xs" name="PILE18"
                                                                        id="PILE18" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="19"><input type="text"
                                                                        class="form-control input-xs" name="PILE19"
                                                                        id="PILE19" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="20"><input type="text"
                                                                        class="form-control input-xs" name="PILE20"
                                                                        id="PILE20" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="21"><input type="text"
                                                                        class="form-control input-xs" name="PILE21"
                                                                        id="PILE21" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="22"><input type="text"
                                                                        class="form-control input-xs" name="PILE22"
                                                                        id="PILE22" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="23"><input type="text"
                                                                        class="form-control input-xs" name="PILE23"
                                                                        id="PILE23" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="24"><input type="text"
                                                                        class="form-control input-xs" name="PILE24"
                                                                        id="PILE24" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="25"><input type="text"
                                                                        class="form-control input-xs" name="PILE25"
                                                                        id="PILE25" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="26"><input type="text"
                                                                        class="form-control input-xs" name="PILE26"
                                                                        id="PILE26" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="27"><input type="text"
                                                                        class="form-control input-xs" name="PILE27"
                                                                        id="PILE27" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="28"><input type="text"
                                                                        class="form-control input-xs" name="PILE28"
                                                                        id="PILE28" placeholder="-PILE-"
                                                                        style="width: 100%"></td>
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td data-no="1" colspan="1">1</td>
                                                        <td class="bg-danger" data-no="2"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_01"
                                                                        id="DRUM_01" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="3"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_02"
                                                                        id="DRUM_02" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="4"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_03"
                                                                        id="DRUM_03" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="5"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_04"
                                                                        id="DRUM_04" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="6"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_05"
                                                                        id="DRUM_05" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="7"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_06"
                                                                        id="DRUM_06" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="8"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_07"
                                                                        id="DRUM_07" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="9"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_08"
                                                                        id="DRUM_08" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="10"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_09"
                                                                        id="DRUM_09" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="11"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_10"
                                                                        id="DRUM_10" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="12"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_11"
                                                                        id="DRUM_11" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="13"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_12"
                                                                        id="DRUM_12" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="14"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_13"
                                                                        id="DRUM_13" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="15"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_14"
                                                                        id="DRUM_14" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                </tr>
                                                <tr class="baris">
                                                        <td data-no="1" colspan="1">2</td>
                                                        <td class="bg-danger" data-no="15"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_15"
                                                                        id="DRUM_15" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="16"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_16"
                                                                        id="DRUM_16" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="17"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_17"
                                                                        id="DRUM_17" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="18"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_18"
                                                                        id="DRUM_18" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="19"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_19"
                                                                        id="DRUM_19" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="20"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_20"
                                                                        id="DRUM_20" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="21"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_21"
                                                                        id="DRUM_21" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="22"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_22"
                                                                        id="DRUM_22" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="23"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_23"
                                                                        id="DRUM_23" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="24"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_24"
                                                                        id="DRUM_24" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="25"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_25"
                                                                        id="DRUM_25" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="26"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_26"
                                                                        id="DRUM_26" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="27"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_27"
                                                                        id="DRUM_27" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="28"><input type="text"
                                                                        class="form-control input-xs" name="DRUM_28"
                                                                        id="DRUM_28" placeholder="-DRUM-"
                                                                        style="width: 100%"></td>
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-danger" data-no="1"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN1" id="TENSIONDEPAN1"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="2"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN2" id="TENSIONDEPAN2"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="3"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN3" id="TENSIONDEPAN3"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="4"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN4" id="TENSIONDEPAN4"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="5"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN5" id="TENSIONDEPAN5"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="6"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN6" id="TENSIONDEPAN6"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="7"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN7" id="TENSIONDEPAN7"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="8"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN8" id="TENSIONDEPAN8"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="9"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN9" id="TENSIONDEPAN9"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="10"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN10" id="TENSIONDEPAN10"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="11"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN11" id="TENSIONDEPAN11"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="12"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN12" id="TENSIONDEPAN12"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="13"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN13" id="TENSIONDEPAN13"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="14"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN14" id="TENSIONDEPAN14"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                </tr>
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-danger" data-no="15"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN15" id="TENSIONDEPAN15"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="16"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN16" id="TENSIONDEPAN16"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="17"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN17" id="TENSIONDEPAN17"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="18"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN18" id="TENSIONDEPAN18"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="19"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN19" id="TENSIONDEPAN19"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="20"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN20" id="TENSIONDEPAN20"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="21"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN21" id="TENSIONDEPAN21"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="22"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN22" id="TENSIONDEPAN22"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="23"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN23" id="TENSIONDEPAN23"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="24"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN24" id="TENSIONDEPAN24"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="25"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN25" id="TENSIONDEPAN25"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="26"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN26" id="TENSIONDEPAN26"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="27"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN27" id="TENSIONDEPAN27"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="28"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONDEPAN28" id="TENSIONDEPAN28"
                                                                        placeholder="-TENSION DEPAN-"
                                                                        style="width: 100%"></td>
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-danger" data-no="1"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG1" id="TENSIONBELAKANG1"
                                                                        placeholder="TENSIONBELAKANG1"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="2"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG2" id="TENSIONBELAKANG2"
                                                                        placeholder="TENSIONBELAKANG2"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="3"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG3" id="TENSIONBELAKANG3"
                                                                        placeholder="TENSIONBELAKANG3"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="4"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG4" id="TENSIONBELAKANG4"
                                                                        placeholder="TENSIONBELAKANG4"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="5"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG5" id="TENSIONBELAKANG5"
                                                                        placeholder="TENSIONBELAKANG5"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="6"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG6" id="TENSIONBELAKANG6"
                                                                        placeholder="TENSIONBELAKANG6"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="7"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG7" id="TENSIONBELAKANG7"
                                                                        placeholder="TENSIONBELAKANG7"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="8"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG8" id="TENSIONBELAKANG8"
                                                                        placeholder="TENSIONBELAKANG8"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="9"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG9" id="TENSIONBELAKANG9"
                                                                        placeholder="TENSIONBELAKANG9"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="10"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG10" id="TENSIONBELAKANG10"
                                                                        placeholder="TENSIONBELAKANG10"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="11"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG11" id="TENSIONBELAKANG11"
                                                                        placeholder="TENSIONBELAKANG11"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="12"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG12" id="TENSIONBELAKANG12"
                                                                        placeholder="TENSIONBELAKANG12"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="13"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG13" id="TENSIONBELAKANG13"
                                                                        placeholder="TENSIONBELAKANG13"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="14"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG14" id="TENSIONBELAKANG14"
                                                                        placeholder="TENSIONBELAKANG14"
                                                                        style="width: 100%">
                                                        </td>
                                                </tr>
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-danger" data-no="15"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG15" id="TENSIONBELAKANG15"
                                                                        placeholder="TENSIONBELAKANG15"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="16"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG16" id="TENSIONBELAKANG16"
                                                                        placeholder="TENSIONBELAKANG16"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="17"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG17" id="TENSIONBELAKANG17"
                                                                        placeholder="TENSIONBELAKANG17"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="18"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG18" id="TENSIONBELAKANG18"
                                                                        placeholder="TENSIONBELAKANG18"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="19"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG19" id="TENSIONBELAKANG19"
                                                                        placeholder="TENSIONBELAKANG19"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="20"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG20" id="TENSIONBELAKANG20"
                                                                        placeholder="TENSIONBELAKANG20"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="21"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG21" id="TENSIONBELAKANG21"
                                                                        placeholder="TENSIONBELAKANG21"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="22"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG22" id="TENSIONBELAKANG22"
                                                                        placeholder="TENSIONBELAKANG22"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="23"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG23" id="TENSIONBELAKANG23"
                                                                        placeholder="TENSIONBELAKANG23"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="24"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG24" id="TENSIONBELAKANG24"
                                                                        placeholder="TENSIONBELAKANG24"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="25"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG25" id="TENSIONBELAKANG25"
                                                                        placeholder="TENSIONBELAKANG25"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="26"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG26" id="TENSIONBELAKANG26"
                                                                        placeholder="TENSIONBELAKANG26"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="27"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG27" id="TENSIONBELAKANG27"
                                                                        placeholder="TENSIONBELAKANG27"
                                                                        style="width: 100%"></td>
                                                        <td class="bg-danger" data-no="28"><input type="text"
                                                                        class="form-control input-xs"
                                                                        name="TENSIONBELAKANG28" id="TENSIONBELAKANG28"
                                                                        placeholder="TENSIONBELAKANG28"
                                                                        style="width: 100%"></td>
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-danger" data-no="1">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR1" id="TENSIONKELUAR1"
                                                                        placeholder="TENSIONKELUAR1"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="2">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR2" id="TENSIONKELUAR2"
                                                                        placeholder="TENSIONKELUAR2"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="3">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR3" id="TENSIONKELUAR3"
                                                                        placeholder="TENSIONKELUAR3"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="4">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR4" id="TENSIONKELUAR4"
                                                                        placeholder="TENSIONKELUAR4"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="5">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR5" id="TENSIONKELUAR5"
                                                                        placeholder="TENSIONKELUAR5"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="6">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR6" id="TENSIONKELUAR6"
                                                                        placeholder="TENSIONKELUAR6"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="7">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR7" id="TENSIONKELUAR7"
                                                                        placeholder="TENSIONKELUAR7"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="8">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR8" id="TENSIONKELUAR8"
                                                                        placeholder="TENSIONKELUAR8"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="9">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR9" id="TENSIONKELUAR9"
                                                                        placeholder="TENSIONKELUAR9"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="10">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR10" id="TENSIONKELUAR10"
                                                                        placeholder="TENSIONKELUAR10"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="11">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR11" id="TENSIONKELUAR11"
                                                                        placeholder="TENSIONKELUAR11"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="12">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR12" id="TENSIONKELUAR12"
                                                                        placeholder="TENSIONKELUAR12"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="13">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR13" id="TENSIONKELUAR13"
                                                                        placeholder="TENSIONKELUAR13"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="14">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR14" id="TENSIONKELUAR14"
                                                                        placeholder="TENSIONKELUAR14"
                                                                        style="width: 100%">
                                                        </td>
                                                </tr>
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-danger" data-no="15">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR15" id="TENSIONKELUAR15"
                                                                        placeholder="TENSIONKELUAR15"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="16">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR16" id="TENSIONKELUAR16"
                                                                        placeholder="TENSIONKELUAR16"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="17">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR17" id="TENSIONKELUAR17"
                                                                        placeholder="TENSIONKELUAR17"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="18">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR18" id="TENSIONKELUAR18"
                                                                        placeholder="TENSIONKELUAR18"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="19">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR19" id="TENSIONKELUAR19"
                                                                        placeholder="TENSIONKELUAR19"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="20">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR20" id="TENSIONKELUAR20"
                                                                        placeholder="TENSIONKELUAR20"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="21">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR21" id="TENSIONKELUAR21"
                                                                        placeholder="TENSIONKELUAR21"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="22">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR22" id="TENSIONKELUAR22"
                                                                        placeholder="TENSIONKELUAR22"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="23">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR23" id="TENSIONKELUAR23"
                                                                        placeholder="TENSIONKELUAR23"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="24">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR24" id="TENSIONKELUAR24"
                                                                        placeholder="TENSIONKELUAR24"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="25">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR25" id="TENSIONKELUAR25"
                                                                        placeholder="TENSIONKELUAR25"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="26">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR26" id="TENSIONKELUAR26"
                                                                        placeholder="TENSIONKELUAR26"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="27">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR27" id="TENSIONKELUAR27"
                                                                        placeholder="TENSIONKELUAR27"
                                                                        style="width: 100%">
                                                        </td>
                                                        <td class="bg-danger" data-no="28">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="TENSIONKELUAR28" id="TENSIONKELUAR28"
                                                                        placeholder="TENSIONKELUAR28"
                                                                        style="width: 100%">
                                                        </td>
                                                ...
                                                <tr>
                                                        ...
                                                        <td class="bg-danger" colspan="2" data-no="2">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="POTONGBULU1" id="POTONGBULU1"
                                                ...
                                                <tr class="baris">
                                                        ...
                                                        <td class="bg-danger" style="width: 100px;" data-no="1"
                                                                colspan="2">
                                                                <input type="text" class="form-control input-xs"
                                                                        name="SPEEDM/MNT_B" id="SPEEDM/MNT_B"
                                                ...
                                                <tr class="baris">
                                                        <td style="width: 180px;" data-no="1" colspan="2">JARAK PISAU
                                                        </td>
                                                        <td class="bg-danger" style="width: 100px;" data-no="1"
                                                                colspan="2">
                                                                <!-- Ganti dengan nilai data statis atau sesuai kebutuhan -->
                                                                <input type="text" class="form-control input-xs"
                                                                        name="JARAKPISAU_B" id="JARAKPISAU_B"
