...
<body>
	<table class="table-ttd" style="width: 90% ;margin-left: 30px; margin-top: 10px; margin-right: 10px; margin-bottom: 10px;">
		<thead>
			<tr>
	...
	<tr>
		...
		<td class="bg-danger" colspan="2" data-no="2" data-name="POTONGBULU1" style="width: 5mm;text-align: center;">
			<?php echo $data['POTONGBULU1']; ?>
		</td>
		<td class="bg-danger" colspan="2" data-no="3" data-name="POTONGBULU2" style="width: 5mm;text-align: center;">
